package vttp.miniProject.AppConfig;
...
//Springboot can identify for it to be used for autowiring, and it goes hand in hand with @bean
@Configuration 
public class AppConfig {
   ...
   @Bean("BeerRedis")//This is to give a name to the bean, and beans allow the method to be used in the springboot framework
   public RedisTemplate<String, String> createRedisConnection() {
      ...
      logger.log(Level.INFO
         , "Using Redis password is set: %b".formatted(redisPassword));
